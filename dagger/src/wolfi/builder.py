...
class Builder:
    ...
    user: Annotated[str | None, Doc("User")] = field(default="nonroot")
    apko_version: Annotated[str | None, Doc("apko version")] = "latest"
    crane_version: Annotated[str | None, Doc("crane version")] = "latest"
    cosign_version: Annotated[str | None, Doc("cosign version")] = "latest"
    grype_version: Annotated[str | None, Doc("grype version")] = "latest"
